    ...
    const meetingDatas = [
        {
            ...
            meetingUrl: "https://shibaura-it.zoom.us/j/98258863232"
        },
        {
            title: "第2回",
            date: "4/17(金) 20:00~",
...
<p>【Zoom入室に関する重要なお願い】</p>
<p>セキュリティおよび参加者確認のため、今回の説明会は「大学のアカウント限定」としています。</p>
<p>必ずZoomアプリ等で一度サインアウトし、「SSO」を選択して大学のメールアドレス（shibaura-it.ac.jp 等）でサインインし直してから、参加リンクをクリックしてください。</p>
<p>※個人のGmail等、大学以外のアカウントでは入室できませんのでご注意ください。</p>
<div class="buttons">
