...
<p>セキュリティおよび参加者確認のため、今回の説明会は大学のアカウントに限定しています。</p>
<p>必ず大学のメールアドレス（...@shibaura-it.ac.jp）でZoomにサインイン（ログイン）してから、参加リンクをクリックしてください。</p>
<p>※個人のアカウント（通常のGmailなど）では参加できない設定になっていますのでご注意ください。</p>
<div class="buttons">
